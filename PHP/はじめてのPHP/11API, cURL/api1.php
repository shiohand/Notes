file_get_contentsで接続

<?php
// Numbers API 日付を渡すと出来事を表示してくれる
$out = file_get_contents('http://numbersapi.com/09/27');
print 'Did you know that '.$out;
?>

クエリ文字列パラメータを含むAPI URLの作成
http_build_query()
  パラメータ名と値の連想配列を渡すとURLにしてくれる
json_decode(), json_encode()
  jsonファイルとPHPのデータ構造の変換

<?php
// NDB API 国民栄養データベース(米国農務省)が公開している。利用は登録が必要
