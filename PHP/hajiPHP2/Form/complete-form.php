...
<table>
  ...
  <tr>
    ...
    <td><?php echo $form->select($GLOBALS['main_dishes'], ['name' => 'sweet', 'multiple' => true]) ?></td>
  </tr>
  <tr>
    <td>Do you want your order delivered?</td>
    <td><?php echo $form->input('checkbox', ['name' => 'delivery', 'value' => 'yes']) ?> Yes </td>
  </tr>
  <tr>
    <td>Enter any special instructions.<br>
    If you want your order delivered, put your address here:</td>
    <td><?php echo $form->textarea(['name' => 'contents']) ?></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><?php echo $form->input('submit', ['value' => 'Order']) ?></td>
  </tr>
</table>
</form>