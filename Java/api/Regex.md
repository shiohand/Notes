...
- [単純な判定](#単純な判定)
- [PatternとMatcherを利用](#patternとmatcherを利用)
- [Patternにフラグ利用](#patternにフラグ利用)
- [サブマッチに名前をつける](#サブマッチに名前をつける)
- [正規表現の機能](#正規表現の機能)
- [サブマッチ目的でないグループを取得しない](#サブマッチ目的でないグループを取得しない)
- [正規表現による文字列の置換と特殊変数](#正規表現による文字列の置換と特殊変数)
- [正規表現によるsplit](#正規表現によるsplit)
